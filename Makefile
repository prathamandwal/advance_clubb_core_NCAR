...
FC := ifort
FC_FLAGS :=   -O3 -ipo -fp-model source -convert big_endian -assume byterecl -ftz -traceback -assume realloc_lhs  -xAVX -mkl -opt-report-phase=vec,loop  -opt-report=5 
#FC_FLAGS :=  -O3 -fp-model fast=2 -convert big_endian -assume byterecl -ftz -traceback -assume realloc_lhs -xAVX  #-xCORE-AVX2
...
pdf_closure_module_test.o: pdf_closure_module_test.F90 kgen_utils.o clubb_precision.o parameters_model.o pdf_parameter_module.o error_code.o constants_clubb.o parameters_tunable.o stats_variables.o saturation.o anl_erf.o array_index.o numerical_check.o interpolation.o
	 ${FC} ${FC_FLAGS} -c -o $@ $<
